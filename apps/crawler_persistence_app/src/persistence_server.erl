...
init([HelperServersCfg, PersistenceCfg]) ->
	...
	{WordsCacheCfg, ConnManagerCfg} = HelperServersCfg,
	State = {WordsCacheCfg, ConnManagerCfg, RetryTimeCfg},
    {ok, State}.
...
get_state_value(conn_manager_server_name, {_, {conn_manager_server_name, Value}, _}) ->
	Value;

get_state_value(retry_time, {_, _, {retry_time, Value}}) ->
	Value.